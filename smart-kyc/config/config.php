...
class dbconfig
{
    public static $emailBaseUrl = "http://192.168.1.32/smart-kyc";
    ...
    public $HOST_POSTGRES = 'host=127.0.0.1';
    public $PORT_POSTGRES = 'port=5432';
    public $DB_NAME_POSTGRES = "dbname = smart_kyc";
    public $CREDENTIALS = "user = postgres password=123123";
    /** @var string - Email config */

    public $EMAIL_HOST = 'smtp.gmail.com';
    public $EMAIL_USERNAME = "letrongtinhtdnu97@gmail.com";
    public $EMAIL_PASSWORD = "fqqdtznmixeuggay";
